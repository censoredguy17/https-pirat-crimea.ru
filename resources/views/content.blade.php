                ...
                <div class="row g-4" id="pirate-gallery">
                    ...
                    @empty
                        ...
                        <div class="col-12 text-center py-5">
                            <div class="empty-state-box p-5"
                                 style="background: rgba(255,255,255,0.03); border-radius: 20px; border: 1px dashed rgba(255,207,64,0.2);">
            ...
            @if($content->textBottom != '')
                ...
                <div class="text-scroll-box js-collapse-section">
                    ...
                    <div class="publish-date mt-3" style="color: black">
                        <i class="fas fa-feather-alt me-2"></i>Бортовой журнал
                        от: {{ $content->created_at->format('d.m.Y') }}
                    </div>
                </div>
